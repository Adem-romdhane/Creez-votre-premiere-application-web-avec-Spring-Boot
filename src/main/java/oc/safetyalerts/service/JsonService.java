...
public class JsonService {
    ...
    public void readData() {
        try (
            ...
            // Accédez aux objets et effectuez les opérations souhai
        ...
        for (MedicalRecords medicalRecord : medicalRecords) {
            System.out.println("Nom : " + medicalRecord.getLastName());
            System.out.println(" Prénom : " + medicalRecord.getFirstName());
